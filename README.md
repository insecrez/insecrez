...
<p align="left">
  <a href="#">
    <br>
    <img src="https://skillicons.dev/icons?i=python,django,flask,anaconda,bash,ruby,java,jenkins,aiscript,git,github,ansible,aws,gcp,azure,docker,kubernetes,grafana,vim,pycharm,idea,debian,powershell,mysql,apple,arch,bots,devto" />
  </a>
</p>
